...
public class VipPaymentActivity extends AppCompatActivity {
    ...
    private void getData() {
        ...
        Constants.databaseReference().child(Constants.VIP_PAYMENTS).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(VipPaymentActivity.this, "No payments found", Toast.LENGTH_SHORT).show();
                }
                adapter = new VipPaymentAdapter(VipPaymentActivity.this, list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Constants.dismissDialog();
                Toast.makeText(VipPaymentActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
